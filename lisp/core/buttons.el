...
;; (buttons-display 'emacs-lisp-buttons)
;; (define-keymap-onto-keymap emacs-lisp-buttons cl-buttons)
;; (buttons-display 'cl-buttons)
;; (buttons-display 'c-buttons)
;; (buttons-display 'cpp-buttons)
;; (buttons-display 'c++-mode-map)
;; (buttons-display 'programming-buttons)
;; (define-key (lookup-key emacs-lisp-buttons (kbd "s-d"))  (kbd "s-x") 'mierda)
;; (lookup-key cl-buttons (kbd "s-d"))
;; (buttons-display (make-composed-keymap (list cl-buttons )))
;; (buttons-display (make-composed-keymap (list cl-buttons emacs-lisp-buttons)))
;; (buttons-display lisp-mode-map)
